...
//////////////////////////////////////////////
const char SSID_ESP[] = "Said";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "3Abakira#";             //Add the password of that WIFI connection
const char* host = "morphological-eight.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
